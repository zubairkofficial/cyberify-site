...
const NewSingleReview = ({ review }) => {
  return (
    <div className="swiper-slide">
      <div className="mil-review">
        <div className="mil-stars mil-mb-30">
          <img
            src={Helpers.staticImage("img/icons/sm/11.svg")}
            alt="quote"
          />
          <ul>
        ...
        <p className="mil-mb-30">{review.review}</p>
        <div className="mil-author">
          <img
            src={Helpers.serverImage(`clients/${review.client_picture}`)}
            alt="Customer"
          />
...
export default NewSingleReview;
